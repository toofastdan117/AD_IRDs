...
# Saving the Pheatmap
#pdf(file = paste0(cwd, "/model_thresholds/classifier_heatmap.pdf"), width = 3.5, height = 6.5)   #for PDFs
#tiff(filename = paste0(cwd, "/model_thresholds/classifier_heatmap.tif"), width = 3.5, height = 6.5, units = "in", res = 300)  #for tiffs
print(heatmap)
#dev.off()
```
